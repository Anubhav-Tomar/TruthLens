    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className='space-y-6'>
        <div className='flex flex-wrap items-center gap-4 '>
            <Badge
                variant="secondary"
                className='relative px-4 py-1.5 text-sm font-medium bg-white/80 backdrop'>
      ...
      <div className='self-start'>
        <Link href="/dashboard">
          <Button
            ...
            rounded-full transition-all duration-200 shadow-xs hover:shadow-md border border-rose-100 
